...
class MessageRepo{
  ...
  Map<int,Message> messages = {
    ...
    2 : Message(id: 2,contactID : 1,date: DateTime.now(),content: 'Hello Firdaouss',type: 'received',selected: false),
    3 : Message(id: 3,contactID : 2,date: DateTime.now(),content: 'Hello Abdeljalil',type: 'received',selected: false),
    4 : Message(id: 4,contactID : 2,date: DateTime.now(),content: 'Hello ',type: 'sent',selected: false),
  };
